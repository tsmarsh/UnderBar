...
## Narrative
This project was cooked up after a series of conversations with Jeff Bay as he explained why:

1. Java 8 is the best platform he's ever used
2. I was doing it wrong

The first point was interesting. I know Jeff because, along with Eric Knell, he was my boss at Outpace, a company that I joined predominantly because it was a Clojure shop.

The second... the second bit peeked my interest.

Jeff's premise is that Java 8 can become functional enough if you abandon classes, tricky in a language where everything is a class based object. The trick?
