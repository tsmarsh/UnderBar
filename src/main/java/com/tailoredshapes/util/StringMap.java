...
public class StringMap implements JSONAware {
    ...
    public static List<StringMap> parseJsonMaps(Path path) {
        ...
        return Objects.map(items, i -> new StringMap(((HashMap<String, Object>) i)));
    }
    ...
    public List<StringMap> makeSmaps(String key) { return Objects.map((Collection<Map<String, Object>>) getCast(key, x -> (Collection<Map<String, Object>>) x), StringMap::new); }
    ...
    public StringMap filterKeys(Predicate<String> predicate) {
        return new StringMap(Objects.filterKeys(m, predicate));
    }
    ...
    public Map<String, Object> toMapDeeply() {
        ...
        result.forEach((key, value) -> {
            if (value instanceof StringMap) {
                ...
                List<Object> convertedValue = Objects.map(v, (element) -> {
    ...
    public StringMap merge(StringMap overrides) {
        return new StringMap(Objects.merge(m, overrides.m));
    }
